...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800 py-5">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between">
          <ul class="flex flex-col md:flex-row items-center">
            ...
            <li class="md:ml-16">
              <a href="{{route('feature-movies.index')}}" class="hover:text-gray-300">Phim lẻ</a>
            </li>
            <li class="md:ml-16">
              <a href="{{route('series.index')}}" class="hover:text-gray-300">Phim bộ</a>
            </li>
            <li class="md:ml-16">
          ...
          <ul class="flex space-x-6 mr-6">
              <li>
                  <a href="{{route('user.dangky')}}" class="hover:text-laravel"
                      ><i class="fa-solid fa-user-plus"></i> Đăng ký</a
                  >
              </li>
              <li>
                  <a href="{{route('user.dangnhap')}}" class="hover:text-laravel"
