            ...
            <div class="md:ml-24">
                ...
                <div class="mt-12 w-56 flex justify-between">
                    @if ($movie['trailer_url'])
                        <a href="{{$movie['trailer_url']}}" class="bg-gray-500 px-6 py-3 font-semibold rounded" target="blank"><button>Trailer</button></a>
                    @endif
                    <a href="{{route('movies.play', $movie['slug'])}}" class="bg-orange-500 px-6 py-3 font-semibold rounded"><button>Xem phim</button></a>
                </div>
            </div>
        </div>
    </div>
